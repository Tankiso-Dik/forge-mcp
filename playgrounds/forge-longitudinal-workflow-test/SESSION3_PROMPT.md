...
This is Session 3, and the deliverable has changed.

Your job:

1. orient yourself from current workspace state
2. handle the new requirement from `TASKS.md`
3. create a real beginner-friendly `STUDY_GUIDE.md`
4. update any project continuity state that should change because of this new direction
5. leave the workspace ready for a final review session
